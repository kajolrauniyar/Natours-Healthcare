...
<?php 
    ...
    if(isset($_GET, $_GET['id']) && !empty($_GET['id'])){
        ...
        if($id <= 0){
            $_SESSION['error'] = "Invalid patients Id";
            @header('location: patients');
            exit;
        }

        $pat_info = getPatientsById($id);//patients data dinxa... valid  data  dinxa through id bata
        if(!$pat_info){//patients data xaina bhnaera check garne
            $_SESSION['error'] = "patients already deleted or does not exists.";
            @header('location: patients');
            exit;
        }
    }
    ...
    <section class="section-about">
        <div class="row-login">
            <div class="container form">
                <form name="patient"  action="patient"  method="post" enctype="multipart/form-data">
                    <h3><?php echo ucfirst($act); ?> Patient's Form</h3>
                    <!-- name -->
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <textarea class="form-control" name="address" value="<?php echo @$pat_info['address']; ?>" placeholder="Enter your Permanent Address" id="address"></textarea> 
                     </div>
                     <!-- status -->
                      <div class="form-group">
